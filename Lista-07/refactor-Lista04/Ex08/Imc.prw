...
/*/{Protheus.doc} User Function L4Ex08
    Algoritmo para calcular o indice de massa corporal de um individuo
    @type  Function
...
Static Function CalcImc(nAltura,nPeso)
	...
	If validapeso(nPeso)
		...
		//verificação do calculo do imc e apresenta o texto em um alerta
		Do case
		case nImc <= 18.5
...
Static Function validapeso(nPeso)
	...
	If cVirgula $ nPeso .or. cPonto $ nPeso
		lRet := .T.
	Else
		lRet := .F.
	EndIF
