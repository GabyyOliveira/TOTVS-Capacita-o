...
Static Function GeraReport()
	...
	Local oRel := TReport():New('RpPedido', 'Relatório de Pedidos de Compra',, { |oRel| Imprime(oRel, cAlias) }, 'Esse Relatório Imprimirá o Pedido de Compra Selecionado', .F.)
...
Static Function Imprime(oRel, cAlias)
	...
	While (cAlias)->(!EOF())
		//se o usuário cancelar a impressão do relatório
		if oRel:Cancel()
			Exit
		endif
